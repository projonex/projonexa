...
export function CareersApplyPage() {
  ...
  return (
    <div className="careers-apply-standalone relative min-h-screen text-zinc-900 dark:text-zinc-100">
      ...
      <StandaloneAppBar backTo="/careers" backLabel="Careers" />

      <div className="relative z-10 mx-auto flex min-h-screen w-full max-w-2xl flex-col px-4 pb-[max(1.5rem,env(safe-area-inset-bottom))] pt-6 sm:px-6 sm:py-10 sm:pb-12 sm:pt-10">
        <motion.header
