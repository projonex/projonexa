...
export const BLOG_PAGE_FAQ = [
  {
    ...
    answer:
      'Projonexa is a premium software and technology services company in India. We help businesses, startups, and engineering students with custom software, MVPs, AI/ML, web and mobile apps, IoT, documentation, and complete project delivery — from scoped quote to deployment and handover.',
  },
  {
  ...
  },
  {
    ...
    answer:
      'Engineering students needing final year or mini projects, startups validating an MVP, businesses needing custom software, researchers needing technical support, and colleges seeking structured project partnerships across India and globally.',
  },
  {
  ...
  },
  {
    ...
    answer:
      'Our blog answers common questions about final year projects, AI and IoT ideas, startup MVPs, documentation, careers, and how Projonexa services work — so you can make informed decisions before reaching out.',
  },
] as const
